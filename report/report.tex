...
To do that, we use an algorithm to decompose the skeleton into a graph. %TODO
...
\begin{center}
  \begin{tabular}{| l | c | c |}
	...
	K-Nearest Neighbors (5 neighbors) & 0.63 & 0.87\\ \hline
	K-Nearest Neighbors (20 neighbors) & 0.51 & 0.92 \\ \hline
